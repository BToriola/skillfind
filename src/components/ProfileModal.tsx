            ...
            <div className="border-t border-slate-100 pt-5">
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-[family-name:var(--font-bricolage)] font-bold text-slate-900">
                  Reviews {reviews.length > 0 && <span className="font-[family-name:var(--font-dm)] text-slate-500 font-normal text-sm">({reviews.length})</span>}
                </h3>
                {canReview && (
              ...
              {loadingReviews ? (
                ...
                <div className="text-center py-6 flex flex-col items-center justify-center">
                  <Star className="text-slate-300 fill-transparent mb-2" size={28} />
